...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_MLX_POWER_SWITCH_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DEVICE_APPEARANCE, 1362);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_TTPMS_IS_2_0, 1);
